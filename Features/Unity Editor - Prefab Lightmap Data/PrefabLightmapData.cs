...
public class PrefabLightmapData : MonoBehaviour
{
        ...
        int textureMaxSize)
    {
        ...
        foreach (PrefabLightmapData instance in prefabs)
        {
            ...
            List<Texture2D> lightmaps2 = new List<Texture2D>();
            ...
            {
                //Prefab
                if (!instance._ignorePrefabSaving)
    ...
    static Texture2D GetLightmapAsset(string filename, string resourcePath, int originalLightmapIndex, Texture2D lightmap)
    {
        ...
        if (importer != null)
        {
            ...
            string assetPath = resourcePath + "-" + originalLightmapIndex + ".asset";
            newLightmap = Instantiate(assetLightmap);
        ...
        else
        {
            DebugExtension.DevLogWarning(
                ...
                "ERROR trying to GetLightmapAsset" + "\n" +
                "file NOT FOUND! " + "\n" +
                "filename = " + filename);
        }
